  ...
  return (
    <main className="mx-auto min-h-[60vh] w-full max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <section className="rounded-3xl border border-border bg-card p-8 shadow-sm sm:p-12">
        ...
        <h1 className="mt-3 text-3xl font-black tracking-tight">Usuarios</h1>
        <p className="mt-4 max-w-2xl text-muted-foreground">Área administrativa para gestión de usuarios.</p>
